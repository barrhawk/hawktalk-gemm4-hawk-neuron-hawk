...
ap.add_argument("--compiled", default=os.path.expanduser("~/llama1b_pc"))
ap.add_argument("--model", default=os.path.expanduser("~/llama1b"))
ap.add_argument("--out", default=os.path.expanduser("~/probe/out"))
...
# --- load ------------------------------------------------------------------
mark("load_start")
config = LlamaInferenceConfig.load(args.compiled)
...
model = NeuronLlamaForCausalLM(args.model, config)
